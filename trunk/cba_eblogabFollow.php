...
<form method="post" class="auto-style9" style="width: auto">
	...
	<span class="auto-style4">
		...
		<img id="img1" alt="About us" height="20" onmousedown="FP_swapImg(1,0,/*id*/'img1',/*url*/'button17A.jpg')" onmouseout="FP_swapImg(0,0,/*id*/'img1',/*url*/'button178.jpg')" onmouseover="FP_swapImg(1,0,/*id*/'img1',/*url*/'button179.jpg')" onmouseup="FP_swapImg(0,0,/*id*/'img1',/*url*/'button179.jpg')" src="button178.jpg" style="border: 0" width="100" /><!-- MSComment="ibutton" fp-style="fp-btn: Chain Column 1" fp-title="About us" --></a>|<a href="cba_eblogabUsers.php"><img id="img2" alt="Users" height="20" onmousedown="FP_swapImg(1,0,/*id*/'img2',/*url*/'button17D.jpg')" onmouseout="FP_swapImg(0,0,/*id*/'img2',/*url*/'button17B.jpg')" onmouseover="FP_swapImg(1,0,/*id*/'img2',/*url*/'button17C.jpg')" onmouseup="FP_swapImg(0,0,/*id*/'img2',/*url*/'button17C.jpg')" src="button17B.jpg" style="border: 0" width="100" /><!-- MSComment="ibutton" fp-style="fp-btn: Chain Column 1" fp-title="Users" --></a>|<a href="cba_eblogabMaintenance.php"><img id="img3" alt="Maintenance" height="20" onmousedown="FP_swapImg(1,0,/*id*/'img3',/*url*/'button180.jpg')" onmouseout="FP_swapImg(0,0,/*id*/'img3',/*url*/'button17E.jpg')" onmouseover="FP_swapImg(1,0,/*id*/'img3',/*url*/'button17F.jpg')" onmouseup="FP_swapImg(0,0,/*id*/'img3',/*url*/'button17F.jpg')" src="button17E.jpg" style="border: 0" width="120" /><!-- MSComment="ibutton" fp-style="fp-btn: Chain Column 1; fp-proportional: 0" fp-title="Maintenance" --></a>|<a href="cba_eblogabSignUp.php"><img id="img4" alt="Sign up" height="20" onmousedown="FP_swapImg(1,0,/*id*/'img4',/*url*/'button183.jpg')" onmouseout="FP_swapImg(0,0,/*id*/'img4',/*url*/'button181.jpg')" onmouseover="FP_swapImg(1,0,/*id*/'img4',/*url*/'button182.jpg')" onmouseup="FP_swapImg(0,0,/*id*/'img4',/*url*/'button182.jpg')" src="button181.jpg" style="border: 0" width="100" /><!-- MSComment="ibutton" fp-style="fp-btn: Chain Column 1" fp-title="Sign up" --></a></span>
</form>
