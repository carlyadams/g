...
<form method="post" class="auto-style9" style="width: auto">
	...
	<span class="auto-style4">
		...
		<img id="img1" alt="About us" height="20" onmousedown="FP_swapImg(1,0,/*id*/'img1',/*url*/'button1B2.jpg')" onmouseout="FP_swapImg(0,0,/*id*/'img1',/*url*/'button1B0.jpg')" onmouseover="FP_swapImg(1,0,/*id*/'img1',/*url*/'button1B1.jpg')" onmouseup="FP_swapImg(0,0,/*id*/'img1',/*url*/'button1B1.jpg')" src="button1B0.jpg" style="border: 0" width="100" /><!-- MSComment="ibutton" fp-style="fp-btn: Chain Column 1" fp-title="About us" --></a>|<a href="cba_eblogabUsers.php"><img id="img2" alt="Users" height="20" onmousedown="FP_swapImg(1,0,/*id*/'img2',/*url*/'button1B5.jpg')" onmouseout="FP_swapImg(0,0,/*id*/'img2',/*url*/'button1B3.jpg')" onmouseover="FP_swapImg(1,0,/*id*/'img2',/*url*/'button1B4.jpg')" onmouseup="FP_swapImg(0,0,/*id*/'img2',/*url*/'button1B4.jpg')" src="button1B3.jpg" style="border: 0" width="100" /><!-- MSComment="ibutton" fp-style="fp-btn: Chain Column 1" fp-title="Users" --></a>|<a href="cba_eblogabMaintenance.php"><img id="img3" alt="Maintenance" height="20" onmousedown="FP_swapImg(1,0,/*id*/'img3',/*url*/'button1B8.jpg')" onmouseout="FP_swapImg(0,0,/*id*/'img3',/*url*/'button1B6.jpg')" onmouseover="FP_swapImg(1,0,/*id*/'img3',/*url*/'button1B7.jpg')" onmouseup="FP_swapImg(0,0,/*id*/'img3',/*url*/'button1B7.jpg')" src="button1B6.jpg" style="border: 0" width="120" /><!-- MSComment="ibutton" fp-style="fp-btn: Chain Column 1; fp-proportional: 0" fp-title="Maintenance" --></a>|<a href="cba_eblogabSignUp.php"><img id="img4" alt="Sign up" height="20" onmousedown="FP_swapImg(1,0,/*id*/'img4',/*url*/'button1BB.jpg')" onmouseout="FP_swapImg(0,0,/*id*/'img4',/*url*/'button1B9.jpg')" onmouseover="FP_swapImg(1,0,/*id*/'img4',/*url*/'button1BA.jpg')" onmouseup="FP_swapImg(0,0,/*id*/'img4',/*url*/'button1BA.jpg')" src="button1B9.jpg" style="border: 0" width="100" /><!-- MSComment="ibutton" fp-style="fp-btn: Chain Column 1" fp-title="Sign up" --></a></span>
</form>
