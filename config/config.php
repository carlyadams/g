...
# Ideally, this should match the domain name
        define('APP_EMAIL', 'info@cbaprofessionals.com'); 
...
*/         
        define('SYSTEM_EMAIL', 'info@cbaprofessionals.com'); 


# Default DB name for this app
        define('DB_NAME', "info@cbaprofessionals.com"); 
...
define('PASSWORD_SALT', 'dTcskjv7Lpfsc6gjlxwvjrnpj');
define('TOKEN_SALT', 'Sdrne3hdejLjv7Lpf9gsa5vjP');
